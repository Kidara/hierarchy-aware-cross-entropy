...
CKPT_DIR  = os.path.join(BASE_DIR, f"checkpoints/NA_Birds/resnet50_softlabels_{BETA_TAG}")
TB_DIR    = os.path.join(BASE_DIR, f"resnet_NABirds/resnet50_softlabels_{BETA_TAG}")
...
model.fc = nn.Linear(model.fc.in_features, N_LEAVES)
