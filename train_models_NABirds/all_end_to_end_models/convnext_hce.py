...
class Params:
    def __init__(self):
        self.batch_size = 128
        self.name = "convnext_hce_0.2_smooth_adj"
        self.workers = 8
        self.lr = 4e-3 * (128 / 4096) * 5
        self.momentum = 0.9
...
model.classifier[2] = nn.Linear(model.classifier[2].in_features, N_LEAVES)
...
writer = SummaryWriter(os.path.join(BASE_DIR, "convnext_NABirds", params.name))
