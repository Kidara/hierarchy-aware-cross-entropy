...
CKPT_DIR  = os.path.join(BASE_DIR, f"checkpoints/NA_Birds/swinT_softlabels_{BETA_TAG}")
TB_DIR    = os.path.join(BASE_DIR, f"resnet_NABirds/swinT_softlabels_{BETA_TAG}")
