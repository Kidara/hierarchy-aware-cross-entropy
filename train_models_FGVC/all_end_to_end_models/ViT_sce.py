...
class Params:
    def __init__(self):
        self.batch_size = 64
        self.name = "vit_sce_0.2_no_smooth_adj"
        self.workers = 8
        self.lr = 3e-3 / 5          # ViT-* ImageNet recipe (Dosovitskiy et al.)
...
writer = SummaryWriter(os.path.join(BASE_DIR, "ViT_fgvc", params.name))
