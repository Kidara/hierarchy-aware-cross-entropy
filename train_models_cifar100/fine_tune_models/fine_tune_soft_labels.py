...
parser.add_argument("--beta", type=float, default=10, choices=[10.0, 30.0, 10000000],
...
CKPT_DIR  = os.path.join(BASE_DIR, f"checkpoints/cifar100/fine_tune_softlabels_{BETA_TAG}")
TB_DIR    = os.path.join(BASE_DIR, f"dinov2_runs_cifar100/fine_tune_softlabels_{BETA_TAG}")
